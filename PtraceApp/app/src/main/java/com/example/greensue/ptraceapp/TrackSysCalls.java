package com.example.greensue.ptraceapp;
...
public class TrackSysCalls extends ExpandableListActivity {
    ...
    private Handler myHandler = new Handler() {
        ...
        public void handleMessage(Message message){
            ...
            Toast.makeText(getApplicationContext(), "TEST"+sysCallObj,
    ...
    private Handler mySpinHandler = new Handler() {
        ...
        public void handleMessage(Message message){
            ...
            Toast.makeText(getApplicationContext(), "默认Toast样式"+filter,
                    Toast.LENGTH_SHORT).show();
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        //DropDown dropDown = new DropDown((LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE), this);
    ...
    public void callTest(String pid, String pname) {
        ...
        new Thread(new Runnable() {
            ...
            try {
                ...
                process = Runtime.getRuntime().exec(new String[]{"/system/bin/sh", "-c", "su -c 'andro" + propid + " & sleep 5'"});
